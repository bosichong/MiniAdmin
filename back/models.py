...
class User(Base):
    ...
    hashed_password = Column(String(128), nullable=False, unique=True, comment='用户密码')
    sex = Column(String(1), nullable=False, default='0', unique=True, comment='用户性别')
    email = Column(String(128), nullable=False, unique=True, comment='用户邮箱')
    status = Column(Integer, nullable=False, default=0, unique=True, comment='帐号状态:0正常 1停用')
